...
% 05/17/2009 : Automatically find out number of dimensions
% 05/19/2009 : Fixed a bug about lower and upper case types
...
type=type';
type=lower(type);
if strcmpi(type,'unsigned byte')==1
    type='uint8';
elseif strcmpi(type,'float')==1
    type='float32';
elseif strcmpi(type,'unsigned short')==1
    type='ushort';
elseif strcmpi(type,'short')==1
    type='short';
elseif strcmpi(type,'Byte')==1
    type='int8';
elseif strcmpi(type,'Integer')==1
    type='int32';
end   
flag=0;
